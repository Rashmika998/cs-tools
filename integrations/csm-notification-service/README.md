...
| Variable | Description |
|---|---|
| `BILLABLE_STATUS_CONSUMER_GROUP` | Consumer group ID this engine's own consumer instances join. Optional — defaults to `csm-notification-service-billable-status` |
| `BILLABLE_STATUS_CONSUMER_COUNT` | How many concurrent consumer instances to run. Optional — defaults to `1` |
